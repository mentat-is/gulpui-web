...
if pnpn scrip return error, or update pnpm version to 11.3 the install script should return error, run the below command to pick which dependencies should be allowed to run scripts
