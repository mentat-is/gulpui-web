  ...
  export function Banner({ ...props }: Banner.Props) {
    ...
    return (
      <UIBanner title='Export'>
        <Stack>
          <Button variant='secondary' img='AcronymSvg' onClick={exportCanvasAsSvg}>Export as SVG</Button>
          <Button variant='secondary' img='AcronymJpg' onClick={exportCanvasAsImage}>Export as image</Button>
          <Button variant='secondary' img='AcronymPage' onClick={no}>Export as XML</Button>
          <Button variant='secondary' img='AcronymCsv' onClick={no}>Export as CSV</Button>
        </Stack>
      </UIBanner>
    )
  }
