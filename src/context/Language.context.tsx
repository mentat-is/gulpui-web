...
const LanguageContext =
  createContext<ILanguageContext | undefined>(undefined) ||
  (() => {
    throw new Error('Хуй')
  })()
...
function validate(languageCode?: string) {
  return !languageCode || !['us', 'it'].includes(languageCode)
    ? 'us'
    : languageCode
}
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  function getLanguagePack(languageCode = 'us'): Translations {
